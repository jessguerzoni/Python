...
america_sul_caribe = dataset[dataset[:, 1] == 'LATIN AMER. & CARIB']

posicao = np.argmax(america_sul_caribe[:, 2].astype(float))

pais = america_sul_caribe[posicao, 0]

gdp = america_sul_caribe[posicao, 2]
